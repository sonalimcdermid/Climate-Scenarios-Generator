...
basefile    <- 'MO060QXX'             ##  .AgMIP base file name in ~\\R\\data\\Climate\\Historical
basedecs 	  <- c(1980, 2009)          ##  Time period of basefile
headerplus  <- 'Balaghat, MP, India with mean and daily variability changes for Tmax, Tmin, and P' 
