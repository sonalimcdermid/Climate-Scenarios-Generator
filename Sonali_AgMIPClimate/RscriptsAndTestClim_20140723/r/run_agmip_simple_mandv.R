...
basefile    <- 'KEMA0XXX'             ##  .AgMIP base file name in ~\\R\\data\\Climate\\Historical
basedecs 	  <- c(1980, 2009)          ##  Time period of basefile
headerplus  <- 'Coimbatore, India with mean and daily variability changes for Tmax, Tmin, and P' 
...
source('/Users/sps246/Research/R/r/RscriptsAndTestClim_20140723/r/agmip_simple_mandv.R')
