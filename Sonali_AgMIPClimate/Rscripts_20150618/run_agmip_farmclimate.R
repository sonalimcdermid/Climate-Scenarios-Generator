...
seedfile    <- 'INHY0QXX'                             ##  .AgMIP seed file name in 
                                                      ##      ~\\R\\data\\Climate\\Historical
shortregion <- 'HY'                                   ##  Short name for output file
headerplus  <- 'Hyderabad, India, district farms'     ##  Additional header information

sitelat     <- c(17.53, 17.53, 15, 15)       ##  Site latitudes,  1st site is station
sitelon     <- c(78.27, 83,  74,  78.27)       ##  Site longitudes, 1st site is station
...
datashort   <- 'SIndiaSriLanka'                              ##  WorldClim subregion
