...
#                added simple file name  6/25/2015

agmip_CMIP5_TandP<- function(rootDir,figDir,Basefile,histfile,shortname,sitename,stnlat,stnlon,
...
#  rootDir<- '/Users/sps246/Research/R/'
  ...
  ##  Input : intype
	...
	prate   <- 8
     ...
     templatefile <- paste(rootDir, 'data/Climate/Historical/USAM0XXX.AgMIP', sep='')
...
##plotting 
jpeg(filename = paste(figDir,shortname,'_',thisrcp,'_',thisfut,'_TandP_',list(mmname=mmname_str),'.jpg', sep = ''), quality = 100)
