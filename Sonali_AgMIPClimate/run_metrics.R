...
# Edited by Sonali McDermid in 2014
	...
	rootDir <- '/Users/sonalimcdermid/Research/R/';
	...
	files <- list.files(path="/Users/sonalimcdermid/Research/R/data/Climate/Historical/", pattern="INMO0XXX", full.names=T, recursive=FALSE)
