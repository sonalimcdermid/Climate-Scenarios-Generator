...
acr_agmip005 <- function(basefile,futfile,outfile,headerplus,shortfile,stnlat,stnlon,stnelev,refht,wndht){
	...
	base <- read.table( basefile, header=FALSE);
	fut <- read.table( futfile, header=FALSE);
